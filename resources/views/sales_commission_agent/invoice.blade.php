...
@section('content')
    ...
    <style>
        ...
        .datatable-header .right-section{
            width:100%;
            display:flex;
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            @can('user.create')
                @slot('tool')
                    <div class="box-tools">
                        <a href="#" class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right" id="add-invoice">
        ...
        <div class="modal fade" id="add-invoice-modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="{{route('invoice.add')}}" method="POST" id="add-invoice-form">
                            @csrf
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <select class="form-control select3 w-100" name="invoice" required>
            ...
            buttons: [
                {
                    ...
                    title: 'Sales Commission Agent Invoice ('+ fullname +')',
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    if (result.success == true) {
                                        $('div#add-invoice-modal').modal('hide');
        ...
        $('#sales_commission_agent_table_invoice').on('dblclick', 'td', function () {
            ...
            input.on('blur keydown', function (e) {
                if (e.type === 'blur' || e.key === 'Enter') {
                    ...
                    var dbId = cell.closest('tr').find('a[data-id]').first().data('id');
