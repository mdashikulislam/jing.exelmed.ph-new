...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('sales-commission-agents/invoice/search/all', [SalesCommissionAgentController::class, 'search'])->name('invoice.search.all');
    Route::post('sales-commission-agents/invoice/add',[SalesCommissionAgentController::class, 'addInvoice'])->name('invoice.add');
    Route::get('sales-commission-agents/invoice/delete-invoice/{id}',[SalesCommissionAgentController::class, 'deleteInvoice'])->name('invoice.delete');
